    ...
    return (
        <Box>
            ...
            <FormControl>
                ...
                {`http://${window.location.host}/meet/${myPeerId}`}
                {/* {`http://${window.location.host}/meet/${peer.id}`} */}
            </FormControl>
